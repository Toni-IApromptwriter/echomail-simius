...
export const translations: Record<Language, Record<keyof typeof BASE_TRANSLATIONS, string>> = {
  ca: {
    ...
    driveSyncEnabled: "Sincronitzar amb Drive",
    calendarController: "Controlador d'Enviaments",
    googleConnected: "Connectat",
    selectCalendar: "Selecciona un calendari",
  ...
  pt: {
    ...
    connectGoogleDrive: "Conectar Google Drive",
    connectGoogleCalendar: "Conectar Google Calendar",
    driveSyncEnabled: "Sincronizar com Drive",
    calendarController: "Controlador de Envios",
    googleConnected: "Conectado",
    selectCalendar: "Selecione um calendário",
    logout: "Sair",
  },
  es: {
    ...
    connectGoogleDrive: "Conectar Google Drive",
    connectGoogleCalendar: "Conectar Google Calendar",
    driveSyncEnabled: "Sincronizar con Drive",
    calendarController: "Controlador de Envíos",
    googleConnected: "Conectado",
  ...
  "en-US": {
    ...
    driveSyncEnabled: "Sync with Drive",
    calendarController: "Send Controller",
  ...
  fr: {
    ...
    driveSyncEnabled: "Synchroniser avec Drive",
    calendarController: "Contrôleur d'envoi",
  ...
  de: {
    ...
    connectGoogleCalendar: "Google Calendar verbinden",
    driveSyncEnabled: "Mit Drive synchronisieren",
    calendarController: "Sendungskontroller",
  ...
  "zh-CN": {
    ...
    connectGoogleCalendar: "连接 Google Calendar",
    driveSyncEnabled: "与 Drive 同步",
    calendarController: "发送控制器",
    googleConnected: "已连接",
    selectCalendar: "选择日历",
    logout: "退出登录",
  },
  "zh-TW": {
    ...
    hoursAgo: "{n} 小時",
    daysAgo: "{n} 天",
    connectGoogleDrive: "連接 Google Drive",
    connectGoogleCalendar: "連接 Google Calendar",
    driveSyncEnabled: "與 Drive 同步",
    calendarController: "發送控制器",
    googleConnected: "已連接",
    selectCalendar: "選擇日曆",
    logout: "登出",
  },
  ja: {
    ...
    hoursAgo: "{n} 時間",
    daysAgo: "{n} 日",
    connectGoogleDrive: "Google Drive を接続",
    connectGoogleCalendar: "Google Calendar を接続",
    driveSyncEnabled: "Drive と同期",
    calendarController: "送信コントローラー",
